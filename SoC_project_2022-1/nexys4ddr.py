...
_io = [
    ("led",  0, Pins("V11"), IOStandard("LVCMOS33")),
    ("led",  1, Pins("V12"), IOStandard("LVCMOS33")),
    ("led",  2, Pins("V14"), IOStandard("LVCMOS33")),
    ("led",  3, Pins("V15"), IOStandard("LVCMOS33")),
    ("led",  4, Pins("T16"), IOStandard("LVCMOS33")),
    ("led",  5, Pins("U14"), IOStandard("LVCMOS33")),
    ("led",  6, Pins("T15"), IOStandard("LVCMOS33")),
    ("led",  7, Pins("V16"), IOStandard("LVCMOS33")),
    ("led",  8, Pins("U16"), IOStandard("LVCMOS33")),
    ("led",  9, Pins("U17"), IOStandard("LVCMOS33")),
    ("led", 10, Pins("V17"), IOStandard("LVCMOS33")),
    ("led", 11, Pins("R18"), IOStandard("LVCMOS33")),
    ("led", 12, Pins("N14"), IOStandard("LVCMOS33")),
    ("led", 13, Pins("J13"), IOStandard("LVCMOS33")),
    ("led", 14, Pins("K15"), IOStandard("LVCMOS33")),
    ("led", 15, Pins("H17"), IOStandard("LVCMOS33")),
    ...
    ("output_motor", 0, Pins("K1"), IOStandard("LVCMOS33")),
    ("output_motor", 1, Pins("F6"), IOStandard("LVCMOS33")),
    ("output_motor", 2, Pins("J2"), IOStandard("LVCMOS33")),
    ("output_motor", 3, Pins("G6"), IOStandard("LVCMOS33")),
