...
module nexys4ddr (
	...
	output reg  uart1_tx,
	input  wire uart1_rx,
	output wire output_motor0,
	output wire output_motor1,
	output wire output_motor2,
	output wire output_motor3
);
...
reg  builder_csrbank1_next0_re = 1'd0;
wire [3:0] builder_csrbank1_next0_r;
reg  builder_csrbank1_next0_we = 1'd0;
wire [3:0] builder_csrbank1_next0_w;
...
assign builder_csrbank0_reset0_w = basesoc_basesoc_reset_storage[1:0];
assign builder_csrbank0_scratch0_w = basesoc_basesoc_scratch_storage[31:0];
assign builder_csrbank0_bus_errors_w = basesoc_basesoc_bus_errors_status[31:0];
assign basesoc_basesoc_bus_errors_we = builder_csrbank0_bus_errors_we;
assign builder_csrbank1_sel = (builder_interface1_bank_bus_adr[13:9] == 2'd2);
assign builder_csrbank1_next0_r = builder_interface1_bank_bus_dat_w[3:0];
always @(*) begin
	builder_csrbank1_next0_re <= 1'd0;
	builder_csrbank1_next0_we <= 1'd0;
	if ((builder_csrbank1_sel & (builder_interface1_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank1_next0_re <= builder_interface1_bank_bus_we;
		builder_csrbank1_next0_we <= (~builder_interface1_bank_bus_we);
	end
end
assign builder_csrbank1_next0_w = basesoc_storage[3:0];
...
assign builder_csrbank2_load0_w = basesoc_basesoc_timer_load_storage[31:0];
assign builder_csrbank2_reload0_w = basesoc_basesoc_timer_reload_storage[31:0];
assign builder_csrbank2_en0_w = basesoc_basesoc_timer_en_storage;
assign builder_csrbank2_update_value0_w = basesoc_basesoc_timer_update_value_storage;
assign builder_csrbank2_value_w = basesoc_basesoc_timer_value_status[31:0];
assign basesoc_basesoc_timer_value_we = builder_csrbank2_value_we;
assign basesoc_basesoc_timer_status_status = basesoc_basesoc_timer_zero0;
assign builder_csrbank2_ev_status_w = basesoc_basesoc_timer_status_status;
assign basesoc_basesoc_timer_status_we = builder_csrbank2_ev_status_we;
assign basesoc_basesoc_timer_pending_status = basesoc_basesoc_timer_zero1;
assign builder_csrbank2_ev_pending_w = basesoc_basesoc_timer_pending_status;
assign basesoc_basesoc_timer_pending_we = builder_csrbank2_ev_pending_we;
assign basesoc_basesoc_timer_zero2 = basesoc_basesoc_timer_enable_storage;
assign builder_csrbank2_ev_enable0_w = basesoc_basesoc_timer_enable_storage;
assign builder_csrbank3_sel = (builder_interface3_bank_bus_adr[13:9] == 3'd5);
assign basesoc_basesoc_uart_rxtx_r = builder_interface3_bank_bus_dat_w[7:0];
always @(*) begin
	...
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_basesoc_uart_rxtx_re <= builder_interface3_bank_bus_we;
		basesoc_basesoc_uart_rxtx_we <= (~builder_interface3_bank_bus_we);
	end
end
...
assign builder_csrbank3_txfull_w = basesoc_basesoc_uart_txfull_status;
assign basesoc_basesoc_uart_txfull_we = builder_csrbank3_txfull_we;
assign builder_csrbank3_rxempty_w = basesoc_basesoc_uart_rxempty_status;
assign basesoc_basesoc_uart_rxempty_we = builder_csrbank3_rxempty_we;
always @(*) begin
...
assign builder_csrbank3_ev_status_w = basesoc_basesoc_uart_status_status[1:0];
assign basesoc_basesoc_uart_status_we = builder_csrbank3_ev_status_we;
always @(*) begin
...
assign builder_csrbank3_ev_pending_w = basesoc_basesoc_uart_pending_status[1:0];
assign basesoc_basesoc_uart_pending_we = builder_csrbank3_ev_pending_we;
...
assign builder_csrbank3_ev_enable0_w = basesoc_basesoc_uart_enable_storage[1:0];
assign builder_csrbank3_txempty_w = basesoc_basesoc_uart_txempty_status;
assign basesoc_basesoc_uart_txempty_we = builder_csrbank3_txempty_we;
assign builder_csrbank3_rxfull_w = basesoc_basesoc_uart_rxfull_status;
assign basesoc_basesoc_uart_rxfull_we = builder_csrbank3_rxfull_we;
assign builder_csrbank4_sel = (builder_interface4_bank_bus_adr[13:9] == 1'd1);
assign basesoc_rxtx_r = builder_interface4_bank_bus_dat_w[7:0];
always @(*) begin
	basesoc_rxtx_re <= 1'd0;
	basesoc_rxtx_we <= 1'd0;
	if ((builder_csrbank4_sel & (builder_interface4_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_rxtx_re <= builder_interface4_bank_bus_we;
		basesoc_rxtx_we <= (~builder_interface4_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((builder_csrbank4_sel & (builder_interface4_bank_bus_adr[8:0] == 1'd1))) begin
		...
		builder_csrbank4_txfull_we <= (~builder_interface4_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((builder_csrbank4_sel & (builder_interface4_bank_bus_adr[8:0] == 2'd2))) begin
		...
		builder_csrbank4_rxempty_we <= (~builder_interface4_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((builder_csrbank4_sel & (builder_interface4_bank_bus_adr[8:0] == 3'd6))) begin
		...
		builder_csrbank4_txempty_we <= (~builder_interface4_bank_bus_we);
	end
end
...
always @(*) begin
	...
	if ((builder_csrbank4_sel & (builder_interface4_bank_bus_adr[8:0] == 3'd7))) begin
		...
		builder_csrbank4_rxfull_we <= (~builder_interface4_bank_bus_we);
	end
end
assign builder_csrbank4_txfull_w = basesoc_txfull_status;
assign basesoc_txfull_we = builder_csrbank4_txfull_we;
assign builder_csrbank4_rxempty_w = basesoc_rxempty_status;
assign basesoc_rxempty_we = builder_csrbank4_rxempty_we;
always @(*) begin
	basesoc_status_status <= 2'd0;
	basesoc_status_status[0] <= basesoc_tx0;
	basesoc_status_status[1] <= basesoc_rx0;
end
assign builder_csrbank4_ev_status_w = basesoc_status_status[1:0];
assign basesoc_status_we = builder_csrbank4_ev_status_we;
always @(*) begin
	basesoc_pending_status <= 2'd0;
	basesoc_pending_status[0] <= basesoc_tx1;
	basesoc_pending_status[1] <= basesoc_rx1;
end
assign builder_csrbank4_ev_pending_w = basesoc_pending_status[1:0];
assign basesoc_pending_we = builder_csrbank4_ev_pending_we;
assign basesoc_tx2 = basesoc_enable_storage[0];
assign basesoc_rx2 = basesoc_enable_storage[1];
assign builder_csrbank4_ev_enable0_w = basesoc_enable_storage[1:0];
assign builder_csrbank4_txempty_w = basesoc_txempty_status;
assign basesoc_txempty_we = builder_csrbank4_txempty_we;
assign builder_csrbank4_rxfull_w = basesoc_rxfull_status;
assign basesoc_rxfull_we = builder_csrbank4_rxfull_we;
...
assign builder_csr_interconnect_dat_r = ((((builder_interface0_bank_bus_dat_r | builder_interface1_bank_bus_dat_r) | builder_interface2_bank_bus_dat_r) | builder_interface3_bank_bus_dat_r) | builder_interface4_bank_bus_dat_r);
always @(*) begin
	builder_array_muxed0 <= 30'd0;
	case (builder_grant)
		default: begin
			builder_array_muxed0 <= basesoc_basesoc_picorv32_idbus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed1 <= basesoc_basesoc_picorv32_idbus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed2 <= basesoc_basesoc_picorv32_idbus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed3 <= basesoc_basesoc_picorv32_idbus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed4 <= basesoc_basesoc_picorv32_idbus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed5 <= basesoc_basesoc_picorv32_idbus_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed6 <= basesoc_basesoc_picorv32_idbus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		default: begin
			builder_array_muxed7 <= basesoc_basesoc_picorv32_idbus_bte;
		end
	endcase
end
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank0_reset0_re) begin
		basesoc_basesoc_reset_storage[1:0] <= builder_csrbank0_reset0_r;
	end
	basesoc_basesoc_reset_re <= builder_csrbank0_reset0_re;
	if (builder_csrbank0_scratch0_re) begin
		basesoc_basesoc_scratch_storage[31:0] <= builder_csrbank0_scratch0_r;
	end
	basesoc_basesoc_scratch_re <= builder_csrbank0_scratch0_re;
	basesoc_basesoc_bus_errors_re <= builder_csrbank0_bus_errors_re;
	builder_interface1_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank1_sel) begin
		case (builder_interface1_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface1_bank_bus_dat_r <= builder_csrbank1_next0_w;
			end
		endcase
	end
	if (builder_csrbank1_next0_re) begin
		basesoc_storage[3:0] <= builder_csrbank1_next0_r;
	end
	basesoc_re <= builder_csrbank1_next0_re;
	...
	if (builder_csrbank2_load0_re) begin
		basesoc_basesoc_timer_load_storage[31:0] <= builder_csrbank2_load0_r;
	end
	basesoc_basesoc_timer_load_re <= builder_csrbank2_load0_re;
	if (builder_csrbank2_reload0_re) begin
		basesoc_basesoc_timer_reload_storage[31:0] <= builder_csrbank2_reload0_r;
	end
	basesoc_basesoc_timer_reload_re <= builder_csrbank2_reload0_re;
	if (builder_csrbank2_en0_re) begin
		basesoc_basesoc_timer_en_storage <= builder_csrbank2_en0_r;
	end
	basesoc_basesoc_timer_en_re <= builder_csrbank2_en0_re;
	if (builder_csrbank2_update_value0_re) begin
		basesoc_basesoc_timer_update_value_storage <= builder_csrbank2_update_value0_r;
	end
	basesoc_basesoc_timer_update_value_re <= builder_csrbank2_update_value0_re;
	basesoc_basesoc_timer_value_re <= builder_csrbank2_value_re;
	basesoc_basesoc_timer_status_re <= builder_csrbank2_ev_status_re;
	if (builder_csrbank2_ev_pending_re) begin
		basesoc_basesoc_timer_pending_r <= builder_csrbank2_ev_pending_r;
	end
	basesoc_basesoc_timer_pending_re <= builder_csrbank2_ev_pending_re;
	if (builder_csrbank2_ev_enable0_re) begin
		basesoc_basesoc_timer_enable_storage <= builder_csrbank2_ev_enable0_r;
	end
	basesoc_basesoc_timer_enable_re <= builder_csrbank2_ev_enable0_re;
	builder_interface3_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= basesoc_basesoc_uart_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_basesoc_uart_txfull_re <= builder_csrbank3_txfull_re;
	basesoc_basesoc_uart_rxempty_re <= builder_csrbank3_rxempty_re;
	basesoc_basesoc_uart_status_re <= builder_csrbank3_ev_status_re;
	if (builder_csrbank3_ev_pending_re) begin
		basesoc_basesoc_uart_pending_r[1:0] <= builder_csrbank3_ev_pending_r;
	end
	basesoc_basesoc_uart_pending_re <= builder_csrbank3_ev_pending_re;
	if (builder_csrbank3_ev_enable0_re) begin
		basesoc_basesoc_uart_enable_storage[1:0] <= builder_csrbank3_ev_enable0_r;
	end
	basesoc_basesoc_uart_enable_re <= builder_csrbank3_ev_enable0_re;
	basesoc_basesoc_uart_txempty_re <= builder_csrbank3_txempty_re;
	basesoc_basesoc_uart_rxfull_re <= builder_csrbank3_rxfull_re;
	builder_interface4_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank4_sel) begin
		case (builder_interface4_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface4_bank_bus_dat_r <= basesoc_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_txfull_re <= builder_csrbank4_txfull_re;
	basesoc_rxempty_re <= builder_csrbank4_rxempty_re;
	basesoc_status_re <= builder_csrbank4_ev_status_re;
	if (builder_csrbank4_ev_pending_re) begin
		basesoc_pending_r[1:0] <= builder_csrbank4_ev_pending_r;
	end
	basesoc_pending_re <= builder_csrbank4_ev_pending_re;
	if (builder_csrbank4_ev_enable0_re) begin
		basesoc_enable_storage[1:0] <= builder_csrbank4_ev_enable0_r;
	end
	basesoc_enable_re <= builder_csrbank4_ev_enable0_re;
	basesoc_txempty_re <= builder_csrbank4_txempty_re;
	basesoc_rxfull_re <= builder_csrbank4_rxfull_re;
	if (sys_rst) begin
...
//------------------------------------------------------------------------------
// Memory rom: 5432-words x 32-bit
//------------------------------------------------------------------------------
...
MOTOR MOTOR(
	.clk(sys_clk),
	.next(basesoc_storage),
	.motorout({output_motor3, output_motor2, output_motor1, output_motor0})
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-06-29 17:54:04.
//------------------------------------------------------------------------------
